$(function () {
            ...
            var shapeDataSource = new $.ig.ShapeDataSource({
                shapefileSource: "http://staging.igniteui.local/15-2/data-files/shapes/world_cities.shp",
                databaseSource: "http://staging.igniteui.local/15-2/data-files/shapes/world_cities.dbf",
